<?php
    ...
    $ns = $_SESSION["Thong_tin_user"]->NgaySinh;
    $date = date_create($ns);
  ...
  <div class="row">
      <div class="col-md-offset-5">
        <div class="form-group">
          <h1 style="font-size: 20pt; color: blue;" ><span class="glyphicon glyphicon-user"></span> Thông Tin Cá Nhân </h1>
        </div>
      </div>
      ...
      <button class="btn btn-success" type="submit" name="btnCNEdit"><span class="glyphicon glyphicon-pencil"></span> Chỉnh sửa thông tin</button>
      </div>
  </div>
</form>
<br>
