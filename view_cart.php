        ...
        if(get_total_items()==0)
        {
            echo '<div class="col-md-offset-4">';
             echo  ' <div class="form-group">';
              echo    '  <h1 style="font-size: 18pt; color: red;" > Giỏ hàng của bạn trống, mời bạn<a href="Index.php"> mua hàng</a> </h1>';
              echo    '  <a href="index.php" > <img src="images/add-to-cart.jpg" style="max-width: 394px;"/></a>';
              echo ' </div>';
            echo '</div>';
            echo '</br></br></br></br>';
